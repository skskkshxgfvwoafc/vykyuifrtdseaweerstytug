...
if (
  ...
  if (isInWebAppiOS == false && isInWebAppChrome == false) {
    isWorking = false;
    $("body").html(
      '<div class="nonono"><p>Для айфона:<br>Нажмите "<span><img style="width: 19px" src="https://cdn-icons-png.flaticon.com/512/157/157960.png"</img></span>", а затем "На экран Домой"</p>Для андроида:<br>Нажмите по трем точкам в браузере и добавьте эту страницу на главный экран<br></div>'
    );
